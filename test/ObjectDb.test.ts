...
describe('ObjectDb', function() {
  describe('integrate', function() {
    ...
    it('should replace a simple classed object with a classed object', function() {
    ...
    it('should replace a simple non-classed object with a non-classed object', function() {
      let db = new ObjectDb(schema, true)
      let obj = {
        id: 1,
        property1: 'a', 
    ...
    it('should replace simple classed object with a non-classed object', function() {
      let db = new ObjectDb(schema, true)
      let obj = new Object1(1, 'a', 1, null, null)
      db.integrate(obj)
    ...
    it('should replace simple non-classed object when with a non-classed object', function() {
      let db = new ObjectDb(schema, true)
      let obj = {
        id: 1,
        property1: 'a', 
    ...
    it('should replace a classed many-to-one relationship with a classed update object', function() {
      let db = new ObjectDb(schema, true)
      let manyObj = new ManyObject(1, 'x', 'a', null)
      let obj1 = new Object1(1, 'b', 2)
      db.integrate([ manyObj, obj1 ])
    ...
    it('should replace a classed many-to-one relationship with a non-classed update object', function() {
      let db = new ObjectDb(schema, true)
      let manyObj = new ManyObject(1, 'x', 'a', null)
      let obj1 = new Object1(1, 'b', 2)
      db.integrate([ manyObj, obj1 ])
      ...
      let updateManyObj = { object1Id: 1, object2Id: 'x', property1: 'b', object1Id2: 1 } as any
      let updateObj1 = { id: 1, property1: 'c', property2: 3 } as any
      updateManyObj.object1 = updateObj1
      ...
      expect(changes.changes).to.deep.equal([
        new Change('Object1', updateObj1, { method: 'update', props: [ 'property1', 'property2' ] }),
        new Change('ManyObject', updateManyObj, { method: 'update', props: [ 'property1', 'object1Id2' ] }),
      ])
    })

    it('should replace a non-classed many-to-one relationship with a classed update object', function() {
      let db = new ObjectDb(schema, true)
      let manyObj = { object1Id: 1, object2Id: 'x', property1: 'a', object1Id2: null, object1: undefined } as any
      let obj1 = { id: 1, property1: 'b', property2: 2 }
      manyObj['object1'] = obj1
    ...
    it('should replace a non-classed many-to-one relationship with a non-classed update object', function() {
      let db = new ObjectDb(schema, true)
      let manyObj = { object1Id: 1, object2Id: 'x', property1: 'a', object1Id2: null, object1: undefined } as any
      let obj1 = { id: 1, property1: 'b', property2: 2 }
      manyObj['object1'] = obj1
    ...
    it('should replace a classed one-to-many relationship with a classed update object when immutable option enabled', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = new Object1(1, 'a', 1)
      let manyObj = new ManyObject(1, 'x', 'b', null)
      db.integrate([ obj1, manyObj ])
      ...
      expect(updateObj1.property1).to.equal('b')
      expect(updateObj1.property2).to.equal(2)
      expect(updateObj1.many).to.deep.equal([ updateManyObj ])
      expect(updateManyObj.property1).to.equal('c')
      expect(updateManyObj.object1).to.equal(updateObj1)
      expect(updateManyObj.object12).to.equal(updateObj1)
    ...
    it('should replace a classed one-to-many relationship with a non-classed update object', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = new Object1(1, 'a', 1)
      let manyObj = new ManyObject(1, 'x', 'b', null)
      db.integrate([ obj1, manyObj ])
      ...
      let updateObj1 = { id: 1, property1: 'b', property2: 2 } as any
      let updateManyObj = { object1Id: 1, object2Id: 'x', property1: 'c', object1Id2: 1 } as any
      updateObj1.many = [ updateManyObj ]
    ...
    it('should replace a non-classed one-to-many relationship with a classed update object', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = { id: 1, property1: 'a', property2: 1 } as any
      let manyObj = { object1Id: 1, object2Id: 'x', property1: 'b', object1Id2: null, object1: undefined } as any
      obj1.many = [ manyObj ]
    ...
    it('should replace with partial objects', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = new Object1(1, 'a')
      obj1.object1Id = null
      db.integrate(obj1)
      ...
      expect(updateObj1.id).to.equal(1)
      expect(updateObj1.property1).to.equal('a')
      expect(updateObj1.property2).to.equal(1)
      expect(updateObj1.object1Id).to.equal(null)
      expect(updateObj1.object2Id).to.equal(null)

      expect(changes.changes).to.deep.equal([
        new Change(updateObj1, { method: 'update', props: [ 'property2', 'object2Id' ] })
      ])
    })
    ...
    it('should not get into a cycle when replacing a recursive one-to-one relationship', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = new Object1(1, 'a', 1, 1)
      db.integrate(obj1)
      ...
      expect(updateObj1.property1).to.equal('b')
      expect(updateObj1.property2).to.equal(2)
      expect(updateObj1.object1).to.equal(updateObj1)
    ...
    it('should replace a many-to-one relationship with a new object', function() {
      let db = new ObjectDb(schema, true)
      let obj11 = new Object1(1, 'a', 1, 2)
      let obj12 = new Object1(2, 'b', 2)
      obj11.object1 = obj12
      ...
      expect(updateObj11.object1).to.equal(obj13)

      let object1s = db.getObjects('Object1')
      expect(object1s.length).to.equal(3)
      expect(object1s[0]).to.equal(obj12)
      expect(object1s[1]).to.equal(updateObj11)
      expect(object1s[2]).to.equal(obj13)

      expect(changes.changes).to.deep.equal([
        new Change(obj13, 'create'),
        new Change(updateObj11, { method: 'update', props: [ 'object1Id' ] }),
      ])
    })
    ...
    it('should add another one-to-many when immutable', function() {
      let db = new ObjectDb(schema, true)
      let obj1 = new Object1(1, 'a', 1)
      let many1 = new ManyObject(1, 'x', 'b')
      obj1.many = [ many1 ]
      ...
      expect(updateObj1.many).to.deep.equal([ many2, many1 ])
